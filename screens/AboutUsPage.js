        ...
        <SafeAreaView>
          ...
          <View className="bg-purple-900 flex-1 ">
            ...
            <Text className="text-white text-xl font-bold">
              Learn about ReferHer and our obsession with getting more women
              into hi-tech
            </Text>
          </View>
          ...
          <View className="bg-slate-200 flex-1">
            <View>
              ...
              <Text className=" text-xl font-bold">
                ...
                internal referrals without stress. We do this with the help of
                our incredible “referrers.” Women at hi-tech companies who have
            ...
            <View>
              <Image
                ...
                style={{ width: 160, height: 130, marginLeft: 10 }}
              />
            </View>
          </View>
          ...
          <View className="bg-purple-900 flex-1">
            <Text className="text-white  text-xl font-bold">
              ...
              She noticed her mentees felt anxious asking strangers for
              referrals. So she came up with the idea for a women's referral
              network.
            </Text>
