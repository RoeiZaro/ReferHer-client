    ...
    <>
      ...
      <View className=" flex-1 bg-purple-800">
        ...
        <View className="flex-row flex-1 bg-purple-300 justify-around items-center">
          <TouchableOpacity className=" bg-purple-800 w-24 h-14  border-2 rounded-xl border-slate-600   items-center justify-center" onPress={() => navigation.navigate("Login")} ><Text className='text-white justify-center' >Login</Text></TouchableOpacity>
          <TouchableOpacity className=" bg-purple-800 w-24 h-14 rounded-xl border-2 border-slate-600  items-center justify-center" onPress={() => navigation.navigate("Register")}><Text className='text-white'>Register</Text></TouchableOpacity>
